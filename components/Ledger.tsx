    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {filteredTransactions.length > 0 ? filteredTransactions.map((t) => (
          <div key={t.id} className="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm active:bg-slate-50 transition-all">
            <div className="flex justify-between items-start mb-4">
              <div className="flex flex-col">
                ...
                <h4 className="text-base font-black text-slate-900 tracking-tight leading-tight">{t.comment}</h4>
              </div>
              <div className="text-right">
                <p className={`text-xl font-black tracking-tighter ${t.type === TransactionType.DEPOSIT ? 'text-green-600' : 'text-rose-600'}`}>
